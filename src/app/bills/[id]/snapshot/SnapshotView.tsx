              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-purple-50">
                    <tr>
                      <th className="p-3 text-left font-semibold text-gray-800 text-sm">Item</th>
                      <th className="p-3 text-right font-semibold text-gray-800 text-sm">Price</th>
                      {participants.map((p: any, index: number) => (
                        <th key={p.id} className="p-2 text-center font-semibold">
                          <div className="flex flex-col items-center gap-1">
                            <div className={`px-2 py-1 rounded-full text-white text-xs font-bold ${getParticipantColor(index)}`}>
                              {p.displayName}
                            </div>
                          </div>
                        </th>
